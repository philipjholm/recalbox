...
define SUPERMODEL_INSTALL_TARGET_CMDS
	...
	mkdir $(TARGET_DIR)/recalbox/share_init/system/configs/model3/NVRAM
endef
...
define SUPERMODEL_LINE_ENDINGS_FIXUP
	...
	sed -i -E -e "s|\r$$||g" $(@D)/Config/Supermodel.ini
