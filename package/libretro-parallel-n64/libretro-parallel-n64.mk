...
LIBRETRO_PARALLEL_N64_VERSION = ffb568713cad9bf0a7838c4a2335c08b146b95b6
...
define LIBRETRO_PARALLEL_N64_BUILD_CMDS
	...
	CFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO) $(LIBRETRO_PARALLEL_N64_FIX_FLAGS)" \
		CXXFLAGS="$(TARGET_CXXFLAGS) $(COMPILER_COMMONS_CXXFLAGS_SO) $(LIBRETRO_PARALLEL_N64_FIX_FLAGS)" \
		...
		PLATCFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO) $(LIBRETRO_PARALLEL_N64_FIX_FLAGS)"
endef
