...
define CONFIGURE_MAIN_3DS_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_3DS),Nintendo 3DS,$(SYSTEM_NAME_3DS),.3ds .3DS .3dsx .3DSX .elf .ELF .axf .AXF .cci .CCI .cxi .CXI .app .APP .zip .ZIP .7z .7Z,3ds,3ds)
endef
